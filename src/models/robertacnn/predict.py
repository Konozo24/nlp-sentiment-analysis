"""Try the trained RobertaCNN model on any tweet you type.

Run:  python -m src.models.robertacnn.predict
      python -m src.models.robertacnn.predict "Messi is on fire!"
"""
...
def load_model():
    ...
    model = RobertaCNN.from_labels(labels)
